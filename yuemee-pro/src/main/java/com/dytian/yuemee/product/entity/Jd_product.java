package com.dytian.yuemee.product.entity;
...
public class Jd_product extends Model<Jd_product> {
     ...
     * 手续费
     */
	private BigDecimal procedures_charge;
    /**
     * 佣金比例
     */
	...
	public BigDecimal getProcedures_charge() {
		return procedures_charge;
	}

	public Jd_product setProcedures_charge(BigDecimal procedures_charge) {
		this.procedures_charge = procedures_charge;
		return this;
	}
	...
	public Jd_product setCommission_ratio(Double commission_ratio) {
	...
	public String toString() {
		return "Jd_product{" +
			...
			", procedures_charge=" + procedures_charge +
