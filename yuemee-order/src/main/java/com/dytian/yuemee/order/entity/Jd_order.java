...
public class Jd_order extends Model<Jd_order> {
    ...
    /**
     * 售后状态：clz,wtg,ytg;(处理中，未通过，已通过)
     */
	private String after_sale_status;
    /**
     * 审核类型：thtk，hh，jtk（退货退款，换货，仅退款）
     */
	...
	public Jd_order setAfter_sale_status(String after_sale_status) {
	...
	public Jd_order setTo_examine_status(String to_examine_status) {
		this.to_examine_status = to_examine_status;
		return this;
	}
	...
	public String toString() {
		return "Jd_order{" +
			...
			", to_examine_status=" + to_examine_status +
